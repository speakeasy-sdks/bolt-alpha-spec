...
func (s *testing) TestingAccountCreate(ctx context.Context, request operations.TestingAccountCreateRequestBodyInput, security operations.TestingAccountCreateSecurity) (*operations.TestingAccountCreateResponse, error) {
...
func (s *testing) TestingShipmentTrackingCreate(ctx context.Context, request operations.TestingShipmentTrackingCreateRequestBody, security operations.TestingShipmentTrackingCreateSecurity) (*operations.TestingShipmentTrackingCreateResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
