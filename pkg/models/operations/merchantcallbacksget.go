...
func (o *MerchantCallbacksGetResponse) GetOnemerchant1callbacksPatchRequestBodyContentApplication1jsonSchema() *shared.Onemerchant1callbacksPatchRequestBodyContentApplication1jsonSchema {
	if o == nil {
		return nil
	}
