...
import (
	"fmt"
	"github.com/speakeasy-sdks/bolt-alpha-spec/internal/hooks"
...
func New(opts ...SDKOption) *BoltAlpha {
	sdk := &BoltAlpha{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			...
			SDKVersion:        "0.11.3",
			GenVersion:        "2.269.0",
			UserAgent:         "speakeasy-sdk/go 0.11.3 2.269.0 1.0.0 github.com/speakeasy-sdks/bolt-alpha-spec",
			Hooks:             hooks.New(),
		},
	}
