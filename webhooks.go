...
func (s *webhooks) WebhooksCreate(ctx context.Context, request operations.WebhooksCreateRequestBodyInput, security operations.WebhooksCreateSecurity) (*operations.WebhooksCreateResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.OnewebhooksPutRequestBodyContentApplication1jsonSchema
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out); err != nil {
				return nil, err
			}

			res.OnewebhooksPutRequestBodyContentApplication1jsonSchema = out
		default:
...
func (s *webhooks) WebhooksDelete(ctx context.Context, request operations.WebhooksDeleteRequest, security operations.WebhooksDeleteSecurity) (*operations.WebhooksDeleteResponse, error) {
	...
	case httpRes.StatusCode == 422:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.WebhooksDelete422ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out); err != nil {
				return nil, err
			}

			res.WebhooksDelete422ApplicationJSONObject = out
		default:
			return nil, sdkerrors.NewSDKError(fmt.Sprintf("unknown content-type received: %s", contentType), httpRes.StatusCode, string(rawBody), httpRes)
		}
	}
...
func (s *webhooks) WebhooksGet(ctx context.Context, request operations.WebhooksGetRequest, security operations.WebhooksGetSecurity) (*operations.WebhooksGetResponse, error) {
	...
	case httpRes.StatusCode == 422:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.WebhooksGet422ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out); err != nil {
				return nil, err
			}

			res.WebhooksGet422ApplicationJSONObject = out
		default:
			return nil, sdkerrors.NewSDKError(fmt.Sprintf("unknown content-type received: %s", contentType), httpRes.StatusCode, string(rawBody), httpRes)
		}
	}
